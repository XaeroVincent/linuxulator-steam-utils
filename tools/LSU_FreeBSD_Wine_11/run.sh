...
export GST_PLUGIN_PATH=/usr/local/lib/gstreamer-1.0 # Force Steam use to system gstreamer for video decoding
...
cp -R "$HOME/.steam/steam/steamapps/common/Proton 11.0/contrib" $HOME/.steam/tmp/FreeBSD_Proton/proton_11.0
